...
const cakeButton = document.querySelector('.cake-c');
...
cakeButton.addEventListener('click', renderCake)
function renderCake(cakes){
for (const cake of cakes) {
        ...
        imgproductcard.setAttribute('src', cake.image)
        divproductinfo.classList.add('product-info')
        pprice.innerText ='$' + cake.price
        pname.innerText = cake.name
        ...
        imgproductcard.addEventListener('click', function(){
                mostrarInfoProduct(cake.image, cake.price, cake.name, cake.desc)
                openProductDetail()
        });
